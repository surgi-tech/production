    ...
    var ScanningModel = Backbone.Model.extend({
        ...
        load_stock_data: function () {
            ...
            var stock_inventory = rpc.query({
                ...
                self.addedScansObj = {};
                self.totalQty = 0;
                //self.datalower=result.datalower;
                self.createdScansObj = {};
                                      console.log("Scheck it");
                var datalow={};
...
console.log(this.datalower)
        ...
        search_product: function (e) {
            ...
            //var lowerobj={};
//for(var i in self.stock_data.data){
//    //obj[i.toLowerCase()] = obj[i];
//    console.log(i);
//    lowerobj[i.toLowerCase()]=self.stock_data.data[i];
//   // delete obj[i];
//}
     console.log(self.stock_data.datalower);
            if (scan_box.trim() != '') {
                ...
                if (modalShown == false) {
                    ...
                    if (self.stock_data.datalower[scanlower] != undefined) {
                        var countProducts = Object.keys(self.stock_data.datalower[scanlower]).length;
                        if (countProducts == 1) {
