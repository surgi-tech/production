...
class payment_register(models.TransientModel):
    ...
    payment_difference = fields.Monetary(compute='compute_payment_difference')
    ...
    def onchange_writeoff_multi_accounts(self):
        if self.writeoff_multi_acc_ids:
            ...
            self.payment_difference = diff_amount




    def _create_payments(self):
        res=super(payment_register, self)._create_payments()
        ...
        #
        #
        # print(diff_amount,"RRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR")
        # amount = self.amount
        ...
        print(lines_list,'LLLLLLLLLLLLLLLLLLL')
        res.update({'writeoff_multi_acc_ids':lines_list})
    ...
    def _create_payment_vals_from_wizard(self):
        ...
        print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
        if not self.currency_id.is_zero(self.payment_difference) and self.post_diff_acc == 'multi' and self.journal_id.type in ['cash','bank']:
            print("222222222222222222222222222222222222222222222222222222",self.salh_amount_total_ids)
            write_off_vals = []
            writeoff_multi_acc=[]
            for woff_payment in self.writeoff_multi_acc_ids:
                ...
                writeoff_multi_acc.append((0,0,{
                    'name': woff_payment.name,
                    'amount': woff_payment.amount_payment,
                    'writeoff_account_id': woff_payment.writeoff_account_id.id,
                    'amt_percent': woff_payment.amt_percent,
                }))

            res['multi_write_off_line_vals'] = write_off_vals
            res['writeoff_multi_acc_ids'] = writeoff_multi_acc
        return res
