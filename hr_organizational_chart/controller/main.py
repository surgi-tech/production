        ...
        if child_ids:
            ...
            for child in child_ids:
                ...
                view = """ <div id='""" + str(child.id) + """' class='o_level_1'><a>
                    ...
                    <p>""" + str(child.job_id.name)+"<br/>"+str(child.company_id.name)+"<br/>"+str(child.department_id.name)+"<br/>"+str(child.grade_id.name)+"<br/>"+str(child.rank_id.name)+"<br/>"+str(child.section_id.name)+"<br/>"+str(child.count_man_employee)+"""</p>
                    </div></a></div>"""
    ...
    def get_parent_child(self, **post):
        if post:
            ...
            for line in post:
                if line:
                    val = int(line)
            print(val,'IIIIIIIIIIKIIIIIIIIIIIII')
            ...
            view = """ <div id="parent" class='o_chart_head'><a>
                ...
                <p>""" + str(emp.name) + """</p>
                <p>""" + str(emp.job_id.name) +"<br/>"+str(emp.company_id.name)+"<br/>"+str(emp.department_id.name)+"<br/>"+str(emp.grade_id.name)+"<br/>"+str(emp.rank_id.name)+"<br/>"+str(emp.section_id.name)+"<br/>"+str(emp.count_man_employee)+ """</p>
