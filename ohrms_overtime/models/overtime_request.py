...
class HrOverTime(models.Model):
    ...
    def hr_approve(self):
        print("Mohamed SSSSSSSSSSSSSSSSSSSSSSSSSSSSS")
...
class HrOverTimeTypeRule(models.Model):
    ...
    from_hrs = fields.Float('From', required=False)
    to_hrs = fields.Float('To', required=False)
    hrs_amount = fields.Float('Rate', required=False)
