...
class product_product(models.Model):
    ...
    #     """
    #     return super(product_product, self)._search_product_quantity(obj, name, domain)
...
class product_template_changes(models.Model):
    ...
    def write(self, vals):
        ...
        return super(product_template_changes, self).write(vals)

    @api.model
    def _price_get(self, products, ptype='list_price'):
        res = super(product_template_changes, self)._price_get(
